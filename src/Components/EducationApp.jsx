...
const EducationApp = () => {
    ...
    let [data,setData]=useState([])
        ...
        useEffect(() => {
            let filteredData = datas.filter(data => data.category==="Education")
      ...
      <div className="w-11/12 mx-auto flex flex-col justify-center items-center">
        ...
        <figure>
         ...
         <div className="flex  items-center justify-between gap-25 w-full">
          ...
          <p>
            {dt.description.slice(0,100)}.... <Link to={`/cardDetails/${dt.id}`} ><span className="text-red-500 underline">Read More</span></Link>
          </p>
